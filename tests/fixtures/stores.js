...
export const ops = {
  officialUrlRules:{ maximumLength:2048, topLevelDomainListVersion:'2026091400', topLevelDomains:['COM', 'RU', 'TEST', 'XN--P1AI'] },
  statuses:[{ value:0, name:'Скрыт', routeAlias:'hidden' }, { value:1, name:'Показывается в общем списке', routeAlias:'active' }, { value:2, name:'Показывается в общем списке и на главной странице', routeAlias:'priority' }],
...
export const store = { id:1, name:'Магазин A', description:'Описание', officialUrl:'https://example.test/', status:0, displayOrder:0,
